...
class ProjectState extends State<Project> {
  ...
  static getInstance() {
    if (this.instance) {
      return this.instance; // check if ProjectState already exists
    }
    this.instance = new ProjectState(); // otherwise create new
...
// adjusting scripts to extend base and generic components, thus making each following script smaller/simpler
// adjust private routes to protected routes to allow inheritence
...
// adjust hover affects per where item has been dragged to
// not droppable yet
